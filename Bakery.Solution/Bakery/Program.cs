...
public class Program
{
  public static void Main()
  {
    ...
    Console.WriteLine("------------------------------------------------");
    Console.WriteLine("Bread is 5 Dollars per Loaf. Buy 2 get 1 free!");
    Console.WriteLine("Pastries are 2 Dollars each, or 3 for 5 Dollars!");
    Console.WriteLine("");
    ...
    Console.WriteLine(newBreadOrder.OrderCost());
    Console.WriteLine("The cost of your pastry order is: ");
    Console.WriteLine(newPastryOrder.OrderCost());
    OrderCalculator newOrderCalculator = new OrderCalculator(); 
    Console.WriteLine("");
    Console.WriteLine("The total cost of your order is: ");
    Console.WriteLine(newOrderCalculator.TotalCost(newBreadOrder.OrderCost(), newPastryOrder.OrderCost()));
  }
}
